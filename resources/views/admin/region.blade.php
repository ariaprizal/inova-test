...
<div class="lg:w-auto lg:h-auto h-full w-full  my-6 mx-8 ">
    <div class="lg:h-auto lg:w-auto w-full h-full">
        <h1 class="text-center my-5">Daftar Wilayah</h1>
        <form action="{{route('region')}}" method="post" class="lg:h-auto lg:w-auto h-full w-full" id="form-tambah">
            @csrf
            <div class="flex lg:flex-wrap">
                <input type="hidden" name="id" id="id">
                <div class="form-group">    
                    <div class='px-2'>
                        <input type="text" name="name" id="name" placeholder="Nama Wilayah" class="pl-2 h-10 w-52 bg-transparent shadow-lg rounded-md placeholder-gray-700 focus:placeholder-transparent focus:outline-none my-2"/>
                    </div>
                </div>
                <div class="form-group">
                    <div class='px-2'>
                        <input type="text" name="address" id="address" placeholder="Alamat Lengkap" class="pl-2 h-10 w-52 bg-transparent shadow-lg rounded-md placeholder-gray-700 focus:placeholder-transparent focus:outline-none my-2" /> 
                    </div>
                </div>
